...
public class SoldDao extends HttpServlet {
    /**
     *
     */
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println("id=" + id + ",index_name=" + indexName+ ",hold=" +hold );
        ...
        try {
            ...
            String sql = "update own_index set hold = '"+hold+"' where index_name = '"+indexName+"' ";
